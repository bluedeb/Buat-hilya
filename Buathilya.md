...
<head>
<title>Script HTML buat Kamu hilya sayang</title>
...
<body>
   ...
   <div id="bodyblur">
     <!-- Wallpaper --><img src="https://i.postimg.cc/FzwQ4Bbj/IMG-20231022-WA0012.jpg" id="wallpaper"/><div id="beneranblur"></div>
   </div>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       ...
       <p id="pesan1">Klik 4 LOVE di Bawah! 򑭤️</p>
       <div id="kolombaru">
         <li id="lv1">🤍</li>
         <li id="lv2">🤍</li>
         <li id="lv3">🤍</li>
       ...
       <p id="pesan5" class="gaya2">Nambah tua aja ya, canda ayang hehe</p>
       <p id="pesan6" class="gaya2">Moga panjang umur biar sehat selalu buat pacarnya abib, diberikan rezeki yang berlimpa❤️</p>
       <p id="pesan7" class="gaya2">Sehat selalu ya , dan juga kita langgeng terus! aku sayang hilya banyak banyak, maaf gabisa kasih apa apa , aku buatin ini aja xixixi , di tanggal 30 okteber ini pacar aku yang paling cantik ulang tahun, yeyyy HBD SAYANG!!!</p>

       <p id="pesan8" class="gaya2">xixixi canda sayang wkwwk :v</p>
       <p id="pesan9" class="gaya2">Oh iya, semoga di hari spesialmu ini kamu dapat menjadi pribadi yang lebih baik yaa.. 🥳❤️</p>
       <p id="pesan10" class="gaya2">Happy Level Up Day buat hilyaaaaaa sayanggggggggg ku🥳</p>
...
<script>
  ...
  var tomnegatif = 'Engga';
    ...
    async function menuju(){pesanwhatsapp = "Makasii udah ngucapin " + nama + " ultah ><";await swals.fire('OK!', 'Kirim jawabannya ke WhatsApp aku, ya!', 'success');window.location = "https://wa.me/6283129020871" + pesanwhatsapp;}
</script>
